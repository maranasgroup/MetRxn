...
<ul>
	...
	<li id="selected"><a href="FJ.php">F-J</a></li>
...
<?php
        ...
        $result = mysql_query("SELECT distinct synonym,sourceName src FROM `biodb4`.`synonymsforPage` where synonym like ('F%') or synonym like ('G%') or synonym like ('H%') or synonym like ('I%') or synonym like ('J%') order by length(synonym)desc,synonym limit 1000;");
