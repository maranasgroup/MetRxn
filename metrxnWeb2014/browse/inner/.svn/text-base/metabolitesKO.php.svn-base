...
<ul>
	...
	<li id="selected"><a href="KO.php">K-O</a></li>
...
<?php
        ...
        $result = mysql_query("SELECT distinct synonym,sourceName src FROM `biodb4`.`synonymsforPage` where synonym like ('K%') or synonym like ('L%') or synonym like ('M%') or synonym like ('N%') or synonym like ('O%') order by length(synonym)desc,synonym limit 1000;");
