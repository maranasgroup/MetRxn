...
// Slightly modified by Peter Csizmadia (cspeter) to work with Chemaxon Marvin
package chemaxon.marvin.modules;
import chemaxon.marvin.util.ProgressObserver; // since 2001.04.26/Marvin 2.7.9
...
public class PngEncoder extends Object
{
    ...
    private ProgressObserver progressObserver; // cspeter 2001.04.26
    ...
    public PngEncoder( Image image,
		       ProgressObserver obs ) // cspeter 2001.04.26
    {
    ...
    {
	if(progressObserver != null) { // cspeter 2001.04.26
	    progressObserver.initProgressMonitor(
		"Writing "+height+" scanlines", 0, height);
	}
        ...
        try
        {
            ...
            {
		if(progressObserver != null) { // cspeter 2001.04.26
		    if(!progressObserver.setProgressValue(height - rowsLeft))
			return false;
		}
	    ...
	    if(progressObserver != null) { // cspeter 2001.04.26
		progressObserver.setProgressValue(height);
	    }
	}
    }
